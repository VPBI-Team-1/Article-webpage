...
async function main() {
  ...
  // 1. Ensure dummy author user exists
  ...
  // 2. Sample data topics for realistic articles
  const articleTemplates = [
    {
      title: "Mastering TypeScript in 2026: Design Patterns and Idioms",
      excerpt: "Explore essential TypeScript patterns that enhance type safety and code readability in large-scale modern applications.",
      image: "https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=800&auto=format&fit=crop&q=60",
    },
    {
      title: "Building Resilient Distributed Systems with Microservices",
      excerpt: "A practical guide to fault tolerance, circuit breakers, and event-driven architecture in distributed backend systems.",
      image: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&auto=format&fit=crop&q=60",
    },
    {
      title: "Understanding Cursor-Based vs Offset Pagination",
      excerpt: "Deep dive into database index scans, stability guarantees, and why cursor pagination scales better for high-traffic apps.",
      image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&auto=format&fit=crop&q=60",
    },
    {
      title: "Modern Database Optimization Strategies with MariaDB and MySQL",
      excerpt: "Techniques for composite indexing, EXPLAIN plan analysis, and query tuning to achieve sub-millisecond response times.",
    ...
    },
    {
      ...
      excerpt: "Organizing your backend codebase into distinct presentation, domain, and data layers to maximize testability and maintainability.",
      image: "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=800&auto=format&fit=crop&q=60",
    },
  ];

  // 3. Generate 25 dummy articles
  console.log("📝 Generating 25 dummy articles...");
